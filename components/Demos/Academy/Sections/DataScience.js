...
export default function DataScience(){
    ...
    return(
        ...
        <div   className='grid lg:grid-cols-2 items-center gap-[50px]'>
            <div>
            <h4  className="text-mainBlack font-bold text-[28px] mb-[10px]">Data Science</h4>
            ...
            <div className='relative'>
                <Image src={'/Images/ArtAndDesign/4.jpg'} width="580px" height={"200px"} alt="" className=' rounded-t-[8px]'/>
